          ...
          <div class="col-sm-12">
            <form class="form-horizontal" method="post">
              ...
              <div class="form-group row">
                ...
                <div class="col-md-10">
                  <input type="text" class="form-control" readonly name = "name" value="${requestScope.product.getName()}">
                </div>
              </div>
              <div class="form-group row">
                <label class="col-md-2 control-label"  for="example-price">Price</label>
                <div class="col-md-10">
                  <input type="number" id="example-price" readonly name="price" class="form-control" value="${requestScope.product.getPrice()}">
                </div>
              </div>
              <div class="form-group row">
                <label class="col-md-2 control-label"  for="example-quantity">Quantity</label>
                <div class="col-md-10">
                  <input type="number" id="example-quantity" readonly name="quantity" class="form-control" value="${requestScope.product.getQuantity()}">
                </div>
              </div>
              <div class="form-group row">
                <label class="col-md-2 control-label">Brand</label>
                <div class="col-md-10">
                  <select name="idBrand" id="idBrand" class="form-control" disabled >
                    <c:forEach items="${applicationScope.brands}" var="brand">
                      <option value="${brand.getId()}"
                      <c:if test="${requestScope.product.getIdBrand() == brand.getId()}">selected</c:if>
